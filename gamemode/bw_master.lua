    ...
    function db:onConnected()
        ...
        function query:onSuccess(data)
            ...
            PlyRepo.initdb(function()
                ply:PrintMessage(HUD_PRINTCONSOLE, "[BW] database player tables have been created.")
            end,function()
                ply:PrintMessage(HUD_PRINTCONSOLE, "[BW] database player tables have failed to be created.")
            end)
...
concommand.Add("bw_init_db", function(ply, cmd, args)
    ...
    if initConfirmation then initdbs(ply) return end
